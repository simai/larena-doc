...
Access принимает решение до разрешения защищённых данных и до активации
snapshot. Композиционный JSON не содержит готовые права и не может расширить
разрешения пользователя. Прямой HTTP-вызов проходит ту же проверку, что и
действие интерфейса.
