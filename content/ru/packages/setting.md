...
В текущем изолированном кандидате одна настройка оформления связана с явным
серверным списком зависимых страниц. Применение использует общий digest набора
их активных снимков. Все активные страницы пересобираются атомарно; ошибка
одной страницы откатывает значение настройки и активации остальных страниц.
Эта проверка выполнена на SQLite, на изолированной схеме MySQL 8.2 и полном
наборе тестов Root. Ревизионные черновики настройки оформления опубликованы в
Setting `main` на ревизии `e0b8c3c44f2bbe8e5dfb201e876b41b06a810d22`; универсальный редактор настроек этим не
заявляется.
